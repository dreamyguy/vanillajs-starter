...
[![NPM Version](https://img.shields.io/badge/npm-v6.9.0-brightgreen.svg)](https://github.com/nodejs/node/releases/tag/v12.4.0)
...
This project outputs production-optimised `javascript` to a folder called `dist`. The resulting file, called `main.js` is compiled out of the [index.js](https://github.com/dreamyguy/vanillajs-starter/blob/master/src/index.js) file, which is the main source.
...
This command compiles the production-optimised `javascript` to `main.js`, a file compiled out of [index.js](https://github.com/dreamyguy/vanillajs-starter/blob/master//src/index.js).

When your function is ready, rename this file to your liking and start referring to your functions, objects, arrays, variables - or whatever it was you defined in your script.
